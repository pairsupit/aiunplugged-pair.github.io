  ...
  <div id="test">
    ...
    <form @submit="submitTest">
        <div class="form">
            ...
            <li>ข้อใดต่อไปนี้กล่าว<u>ผิด</u> เกี่ยวกับจุดในภาพข้างใต้ เมื่อแต่ละสีของจุดหมายถึงสีลูกศรการเคลื่อนที่ที่เป็นไปได้ของ the sweet computer
                <br>
            ...
            <li>ทุกข้อต่อไปนี้กล่าวถูกต้อง<u>ยกเว้น</u>ข้อใด
